...
DEFAULT_SETTINGS = {
    ...
    "bg_fill": "cover",        # 背景图填充方式
    "font_size": 100,          # 全局字号比例 %
    "dark_strength": 72,       # 背景遮罩深色强度 %
    "font_family": "system",  # system / microsoft / segoe / mono
    "ai": {
...
def public_view(s: dict) -> dict:
    ...
    return {
        ...
        "font_size": s.get("font_size", 100),
        "dark_strength": s.get("dark_strength", 72),
